	...
	<div id="content">
		...
		<nav class="horizontal-nav">
			<form method="post">
		        ...
		        <li><a href="movies.php" class="current">Movies</a></li>
		...
		<div id="main_content">
			...
			<div class="movie_right">
				...
				<img class="movie_img" src="imagesHTML/theinternship.jpg" alt="internship">

				

			</div>
			<?php 
					$_SESSION["EVENT_TYPE"] = "movies";
		...
		<footer id="footer_div">
				...
				<div class="social_media">
					...
					<h2>Follow Us</h2>
					<ul>
						<li><img class="icon_img" src="imagesHTML/facebook_icon.png" alt="facecrap">&nbsp;<a href="#">Facebook</a></li>
						<li><img class="icon_img" src="imagesHTML/twitter-icon.png" alt="twit">&nbsp;<a href="#">Twitter</a></li>
