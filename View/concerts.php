	...
	<div id="content">
		...
		<nav class="horizontal-nav">
			<form method="post">
		        ...
		        <li><a href="#" class="current">Concerts</a></li>
			...
			<div id="event_top">
				...
				<div class="top_left">
					...
					<ul>
						...
						<li><a href="">Uniprix Stadium</a></li>
						<li><a href="">Bell Center</a></li>
				...
				<div id="banner_container">
			      ...
			      <div id="banner-fade">
			        ...
			        <ul class="bjqs">
			          <li><img src="imgSlider/concert_banner.jpg" alt="gt" title="Mtl Concerts"></li>
			          <li><img src="imgSlider/metropolis.jpg" alt="gt" title="Metropolis"></li>
			          <li><img src="imgSlider/osheaga.jpg" alt="gt" title="Osheaga"></li>
			        </ul>
