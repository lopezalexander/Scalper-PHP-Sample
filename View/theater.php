	...
	<div id="content">
		...
		<nav class="horizontal-nav">
			 <form method="post">
		        ...
		        <li><a href="theater.php" class="current">Theatrical</a></li>
		...
		<div id="main_content">
			...
			<div id="event_top">
				...
				<div id="banner_container">
			      ...
			      <div id="banner-fade">
			        ...
			        <ul class="bjqs">
			          <li><img src="imgSlider/cleopatra.jpg" title="Cleopatra"></li>
			          <li><img src="imgSlider/broadway_banner.jpg" title="NY Broadway"></li>
			          <li><img src="imgSlider/nutcracker_2012_banner.jpg" title="The Nutcracker"></li>
			        </ul>
			...
			<?php $_SESSION["EVENT_TYPE"] = "theatrical";
